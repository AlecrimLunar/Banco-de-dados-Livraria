...
public abstract class GerenciaCon extends ControlaBD{
     ...
     * </ul>
     */
    protected static int InsertRetornando(String tabela, String infos, String atributos) throws NaoTemConexaoException{
        if (connection != null) {
            try {
     ...
     * </ul>
     */
    protected static int Existe(String tabela, String coluna, String condicao) throws NaoTemConexaoException{
        ResultSet rt = null;
        if (connection != null){
            try {
    ...
    protected static ResultSet Select(String tabela, String coluna, String pesquisa) throws NaoTemConexaoException {
        if (connection != null){
            try{
     ...
     * ConexaoException
     */
    protected static int login(String user, String password, String tabela) throws NaoTemConexaoException{
        ResultSet rt = null;
        if (connection != null){
            try{
   ...
   // protected int variosUpdatesMesmaColuna(String tabela, String coluna, ArrayList<String> novo, ArrayList<String> condicao) throws NaoTemConexaoException{}
